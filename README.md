...
- `docs/PAPER_RESULT_ARTIFACTS.md`: result-artifact requirements and expected schemas
...
Use `--audit-inputs` to check that local artifacts are present before running a target:
